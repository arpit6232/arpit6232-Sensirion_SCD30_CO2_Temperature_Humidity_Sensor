#ifndef _ROS_ouster_driver_PacketMsg_h
#define _ROS_ouster_driver_PacketMsg_h
...
namespace ouster_driver
{
  ...
  class PacketMsg : public ros::Msg
  {
    ...
    const char * getType(){ return "ouster_driver/PacketMsg"; };
    const char * getMD5(){ return "4f7b5949e76f86d01e96b0e33ba9b5e3"; };
